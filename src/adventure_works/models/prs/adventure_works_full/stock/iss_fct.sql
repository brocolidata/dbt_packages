...
iss as (
    select
        ...
        coalesce(
            nd.quantite_entree_past_month, 0
        ) as quantite_entree_past_month,
        coalesce(
            nd.quantite_sortie_past_month, 0
        ) as quantite_sortie_past_month,
        coalesce(
            nd.quantite_restante_past_month, 0
        ) as quantite_restante_past_month,
        coalesce(
            nd.quantite_entree_same_month_last_year, 0
        ) as quantite_entree_same_month_last_year,
        coalesce(
            nd.quantite_sortie_same_month_last_year, 0
        ) as quantite_sortie_same_month_last_year,
        coalesce(
            nd.quantite_restante_same_month_last_year, 0
        ) as quantite_restante_same_month_last_year,
        coalesce(
            nd.quantite_entree_sum_past_3months, 0
        ) as quantite_entree_sum_past_3months,
        coalesce(
            nd.quantite_sortie_sum_past_3months, 0
        ) as quantite_sortie_sum_past_3months,
        coalesce(
            nd.quantite_entree_sum_past_6months, 0
        ) as quantite_entree_sum_past_6months,
        coalesce(
            nd.quantite_sortie_sum_past_6months, 0
        ) as quantite_sortie_sum_past_6months,
        coalesce(
            nd.quantite_entree_avg_past_3months, 0
        ) as quantite_entree_avg_past_3months,
        coalesce(
            nd.quantite_sortie_avg_past_3months, 0
        ) as quantite_sortie_avg_past_3months,
        coalesce(
            nd.quantite_entree_avg_past_6months, 0
        ) as quantite_entree_avg_past_6months,
        coalesce(
            nd.quantite_sortie_avg_past_6months, 0
        ) as quantite_sortie_avg_past_6months,
        coalesce(
            nd.quantite_entree_pop_difference_prev_month, 0
        ) as quantite_entree_pop_difference_prev_month,
        coalesce(
            nd.quantite_sortie_pop_difference_prev_month, 0
        ) as quantite_sortie_pop_difference_prev_month,
        coalesce(
            nd.quantite_entree_pop_difference_same_month_prev_year, 0
        ) as quantite_entree_pop_difference_same_month_prev_year,
        coalesce(
            nd.quantite_sortie_pop_difference_same_month_prev_year, 0
        ) as quantite_sortie_pop_difference_same_month_prev_year,
        coalesce(
            nd.quantite_entree_ptd_sum_quarter, 0
        ) as quantite_entree_ptd_sum_quarter,
        coalesce(
            nd.quantite_sortie_ptd_sum_quarter, 0
        ) as quantite_sortie_ptd_sum_quarter,
        coalesce(
            nd.quantite_entree_ptd_sum_year, 0
        ) as quantite_entree_ptd_sum_year,
        coalesce(
            nd.quantite_sortie_ptd_sum_year, 0
        ) as quantite_sortie_ptd_sum_year,
